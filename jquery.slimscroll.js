    ...
    slimScroll: function (options) {
      ...
      this.each(function () {
        ...
        function scrollContent(x, y, isWheel, isJump) {
          ...
          var deltaY = y;
          var maxTop =
            me.outerHeight() - bar.outerHeight() - (o.horizontal ? o.size : 0);
          var barHeight;
          var maxLeft =
            o.horizontal && me.outerWidth() - barH.outerWidth() - o.size;
          ...
          if (isWheel) {
            ...
            barHeight =
              (me.outerHeight() * me.outerHeight()) / me[0].scrollHeight;

            // move bar with mouse wheel
            deltaY =
              parseFloat(bar.css("top")) +
              (y * barHeight * parseInt(o.wheelStep)) / 100;
            ...
            deltaY =
              y > 0
                ? Math.ceil(deltaY * 1000.0) / 1000.0
                : Math.floor(deltaY * 1000.0) / 1000.0;
            ...
            if (o.horizontal) {
              deltaX =
                parseInt(barH.css("left")) +
                ((x * parseInt(o.wheelStep)) / 100) * barH.outerWidth();
          ...
          percentScrollY =
            parseFloat(bar.css("top")) / (me.outerHeight() - bar.outerHeight());
          ...
          if (o.animate) {
            ...
            me.stop(true, true).animate(
              { scrollTop: deltaY, scrollLeft: deltaX },
              200,
              "linear"
            );
          } else {
        ...
        function getBarWidth() {
          ...
          barWidth = o.barFixSize
            ? parseInt(o.barFixSize)
            : Math.max(
                (me.outerWidth() / me[0].scrollWidth) * me.outerWidth(),
                minBarWidth
              );
        ...
        function showBar() {
          ...
          if (
            percentScrollY == ~~percentScrollY ||
            percentScrollX == ~~percentScrollX
          ) {
            //release wheel
          ...
          if (o.horizontal) {
            if (~~barWidth >= ~~me.outerWidth()) {
              ...
              if (o.railVisible) {
                railH.stop(true, true).fadeIn("fast");
              }
            }
          }
        }
